...
/** Default delimiter between symbols: none, so symbols are concatenated. */
...
export interface GenerateOptions {
  ...
  length?: number;
  /** String placed between symbols. Default "" (no delimiter). Pass "-" for hyphens. */
  delimiter?: string;
  /**
...
export interface ValidateOptions {
  /** Delimiter the token was joined with. Default "" (no delimiter). */
  delimiter?: string;
